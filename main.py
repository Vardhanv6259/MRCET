...
def madUnit1(message):
    madUnit1 = open('mrcet/mad/mad_unit1.pdf', 'rb')
...
def madUnit2(message):
    madUnit2 = open('mrcet/mad/mad_unit2.pdf', 'rb')
...
def madUnit3(message):
    madUnit3 = open('mrcet/mad/mad_unit3.pdf', 'rb')
...
def madUnit4(message):
    madUnit4 = open('mrcet/mad/mad_unit4.pdf', 'rb')
...
def madUnit5(message):
    madUnit5 = open('mrcet/mad/mad_unit5.pdf', 'rb')
...
def mlUnit1(message):
    mlUnit1 = open('mrcet/ml/ml_unit1.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 1 notes')
...
def mlUnit2(message):
    mlUnit2 = open('mrcet/ml/ml_unit2.docx', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 2 notes')
...
def mlUnit3(message):
    mlUnit3 = open('mrcet/ml/ml_unit3.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 3 notes')
...
def mlUnit4(message):
    mlUnit4 = open('mrcet/ml/ml_unit4.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 4 notes')
...
def mlUnit5(message):
    mlUnit5 = open('mrcet/ml/ml_unit5.pdf', 'rb')
    mlUnit05 = open('mrcet/ml/ml_unit05.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 5 notes')
...
def idsUnit4(message):
    idsUnit4 = open('mrcet/ids/ids_unit4.docx', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 4 notes')
...
def idsUnit5(message):
    idsUnit5 = open('mrcet/ids/ids_unit5.docx', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 5 notes')
...
def RnAUnit1(message):
    RnAUnit1 = open('mrcet/rna/RnA_unit1.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 1 notes')
...
def RnAUnit2(message):
    RnAUnit2 = open('mrcet/rna/RnA_unit2.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 2 notes')
...
def RnAUnit3(message):
    RnAUnit3 = open('mrcet/rna/RnA_unit3.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 3 notes')
...
def RnAUnit4(message):
    RnAUnit4 = open('mrcet/rna/RnA_unit4.pdf', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 4 notes')
...
def stmUnit1(message):
    stmUnit1 = open('mrcet/stm/stm_unit1.pptx', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 1 notes')
...
def stmUnit2(message):
    stmUnit2 = open('mrcet/stm/stm_unit2.pptx', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 2 notes')
...
def stmUnit3(message):
    stmUnit3 = open('mrcet/stm/stm_unit3.pptx', 'rb')
    bot.send_message(message.chat.id, 'Here is your unit 3 notes')
...
def madManual(message):
    madManual = open('mrcet/madManual/madManual.pdf', 'rb')
...
def mlManual(message):
    mlManual = open('mrcet/mlManual/mlManual.pdf', 'rb')
    bot.send_message(message.chat.id, "Here is your manual")
...
def assignmentTemplate(message):
    assignmentTemplate = open('mrcet/booklet/AssignmentTemplate.pdf', 'rb')
...
def appdev(message):
    AbstractSubmissionForm = open('mrcet/booklet/AbstractSubmissionForm.pdf', 'rb')
